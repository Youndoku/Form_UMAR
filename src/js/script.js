window.onload = function () {
    alertbox.render({
        ...
        message: `Harap tunggu sementara lokasi Anda diperiksa. Pastikan GPS Anda aktif dan Anda berada di dalam radius 55 meter dari lokasi PTQ.`,
        border: true,
        themeColor: '#664889',
        btnTitle: '',
        btnColor: '#ffffff',
        ...
        navigator.geolocation.getCurrentPosition(function (position) {
            ...
            if (distance <= radius) {
                ...
                setTimeout(() => {
                    ...
                    if (alertButton) {
                        alertButton.addEventListener('click', function () {
                            updateUI('Lokasi Sesuai!', `Lokasi anda: Sekitar Sekretariat PTQ. Anda berada dalam radius ${distance.toFixed(2)} meter dari pusat.`, false);
                ...
                alertbox.render({
                    ...
                    message: `Akses ke Presensi dibatasi untuk lokasi tertentu. Seharusnya Anda mendekat ke Sekretariat PTQ dalam Radius 55 meter. <br><br>Anda berada dalam radius ${distance.toFixed(2)} meter dari pusat. Kurang dekat! Butuh sekitar ${((radius - distance).toFixed(2))} meter lagi.`,
                    btnTitle: 'Coba Lagi',
                    btnColor: '#FFA500',
                    border: true,
                    themeColor: '#FFA500',
